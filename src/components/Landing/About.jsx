...
const WelcomeGroup = () => {
  return (
    ...
    style={{
      backgroundImage: `
        ...
        url('https://cdn.pixabay.com/photo/2023/03/12/16/10/man-7847247_960_720.jpg')`,
  ...
  >
      ...
      <div className="absolute top-8 left-5 md:top-10 md:left-10 text-center md:text-left">
        <h1 className="text-4xl lg:flex flex-col text-center items-center md:text-6xl font-bold text-green-400 italic">
          Welcome to  
      ...
      <div className="w-full max-w-2xl md:max-w-4xl border backdrop-blur-sm border-green-400 p-6 md:p-8 text-sm md:text-lg text-justify bg-black bg-opacity-70 rounded-lg mt-32 md:mt-0">
        <p>
        At HABFIT, our mission is to help people transform their lifestyle
          by building sustainable, healthy habits. We believe fitness is not just
          about quick results—it's about long-term well-being. Our goal is to
          make fitness and health a priority in your life while ensuring that
          training is accessible, effective, and affordable for everyone.
        </p>
      </div>
    </div>
  );
