...
const ServicesSection = () => {
  ...
  // Handle scrolling to the details section when component mounts
  useEffect(() => {
  ...
  return (
    <div  className="bg-black text-green-400 py-16 px-4 sm:px-6 lg:px-8 flex justify-center">
      <div className="max-w-7xl w-full bg-black rounded-lg p-10 border border-green-400/30 shadow-2xl shadow-green-400/10">
        {/* Section Heading */}
        <div id="details" className="bg-gray-900 rounded-lg p-8 mb-12 border border-green-400/20 shadow-lg">
        ...
        <div className="flex justify-center mt-12">
          <button 
            ...
            className="bg-green-400 hover:bg-green-500 text-black font-bold text-lg px-8 py-3 rounded-full transition-all transform hover:scale-105 hover:shadow-lg hover:shadow-green-400/20"
          >
            JOIN NOW
          </button>
        </div>
