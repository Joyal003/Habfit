      ...
      <div className="flex flex-col md:flex-row items-stretch w-full max-w-6xl gap-16">
        ...
        <div className="bg-white text-black p-8 rounded-xl shadow-lg w-full md:w-2/5 flex-1 flex flex-col justify-center">
          ...
          <p className="text-lg text-center mt-4">
            Our Lifestyle Transformation are currently offered at an exclusive
            discounted price, we only accept a limited number of clients each
            month to ensure personalized attention. Take action now to secure
            your spot and start your journey to a stronger, healthier you, Don't
            wait until it's too latel.book your consultation now
          </p>
