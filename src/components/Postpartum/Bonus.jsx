  ...
  const bonuses = [
    {
      ...
      description:
        "A 104-page guide featuring healthy, customized recipes complete with macros and calorie details. Choose meals that align with your calorie needs.",
      worth: "2000",
    },
    {
      title: "Progress Tracker Sheet",
      description:
        "Track your measurements, automatically calculate body fat, TDEE, BMR, and heart rate zones. Monitor your progress from the start and assess how well you’re improving.",
      worth: "500",
    },
    {
      title: "Daily Tracker Sheet",
      description:
        "Log your daily weight and steps to calculate weekly averages. Use this data to adjust and achieve your weekly step targets effectively.",
      worth: "500",
    },
    {
      title: "Calorie Tracker Sheet",
      description:
        "Enter your daily calorie and macro intake to get a weekly average. Use this insight to tweak your intake and hit your goals efficiently.",
      worth: "500",
    },
  ];

  const totalWorth = 3500;
