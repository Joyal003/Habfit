    ...
    <div className="bg-black text-white py-16 px-5 sm:px-20 flex flex-col md:flex-row items-center justify-center gap-10">
      ...
      <div className="flex flex-col md:flex-row items-stretch w-full max-w-6xl gap-16">
        ...
        <div className="relative w-full md:w-4/5 bg-gray-900 rounded-2xl flex-1">
          <img
            src="https://images.pexels.com/photos/416747/pexels-photo-416747.jpeg"
            alt="Workout"
        ...
        <div className="bg-white text-black p-8 rounded-xl shadow-lg w-full md:w-2/5 flex-1 flex flex-col justify-center">
          ...
          <p className="text-lg text-center text-emerald-500 mt-4">
            Our group class fitness programs are currently offered at an
            exclusive discounted price, we only accept a limited number of
            clients each month to ensure personalized attention. Take action now
            to secure your spot and start your journey to a stronger, healthier
            you, Don't wait until it's too latel .book your consultation now
          </p>
