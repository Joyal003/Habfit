              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-gradient-to-r from-green-900/20 to-emerald-900/20 rounded-xl">
                  <p className="text-2xl font-semibold mb-2">
                    Price For You: <span className="text-green-400 font-bold">₹ 15,999/- (16 Weeks)</span>
                    <br/>
                    Price per Month: <span className="text-green-400 font-bold">₹ 3,999/</span>
                  </p>
                  <p className="text-lg line-through text-red-400 mb-2">
                    Normal Price: <span>₹ 28,000</span>
                  </p>
                  <p className="text-red-700 text-2xl font-bold">
                    Register now for FREE bonuses worth ₹12,500!
                  </p>
                </div>
              </div>
            </div>
